...
3. Your application is deployed! (e.g. [vue-template.vercel.app](https://vue-template.vercel.app/))

```bash
$ npm i -g vercel
$ vercel init vue
Vercel CLI
> Success! Initialized "vue" example in ~/your-folder.
- To deploy, `cd vue` and run `vercel`.
```

#### Vercel for Git

1. Push your code to your git repository (GitHub, GitLab, BitBucket).
2. [Import your Vue project](https://vercel.com/new) into Vercel.
3. Vercel will detect that you are using Vue and will enable the correct settings for your deployment.
4. Your application is deployed! (e.g. [vue-template.vercel.app](https://vue-template.vercel.app/))
