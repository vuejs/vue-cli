...
Опции:
  ...
  --dest             определить каталог сборки (по умолчанию: dist)По умолчанию для создания каталога вывода по умолчанию укажите безопасный пустой каталог, не указывайте каталог типа "/" с:/".
