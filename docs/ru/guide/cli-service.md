...
Команда `vue-cli-service build` создаёт готовую для production сборку в каталоге `dist/`, с минификацией для JS / CSS / HTML и автоматическим разделением вендорного чанка для лучшего кэширования. Манифест чанка вставляется инлайн в HTML.
