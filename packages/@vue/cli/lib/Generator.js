...
const normalizeFilePaths = require('@vue/cli-global-utils/lib/util/normalizeFilePaths')
const runCodemod = require('@vue/cli-global-utils/lib/util/runCodemod')
    ...
    Object.keys(files).forEach(file => {
      ...
      if (imports && imports.length > 0) {
        files[file] = runCodemod(
          require('@vue/cli-global-utils/lib/util/codemods/injectImports'),
      ...
      if (injections && injections.length > 0) {
        files[file] = runCodemod(
          require('@vue/cli-global-utils/lib/util/codemods/injectOptions'),
          { path: file, source: files[file] },
          { injections }
        )
      }
