...
- **pwa.manifestOptions**
  ...
  - Default: `{}`
    ...
    If the following attributes are not defined in the object, the options of `pwa` or default options will be used instead.
      ...
      - icons: `pwa.manifestOptions.icons`
...
- **pwa.manifestOptions.icons**
  ...
  - Default:
    ...
    This option is the image used in the manifest.json file.
    See [this article](https://web.dev/add-manifest/#icons) for more details.
