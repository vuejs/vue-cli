module.exports = (api, { config, lintOn = [] }) => {
  ...
  if (config === 'airbnb') {
    ...
    Object.assign(pkg.devDependencies, {
      '@vue/eslint-config-airbnb': '^3.0.0-beta.8'
    })
  } else if (config === 'standard') {
    pkg.eslintConfig.extends.push('@vue/standard')
    Object.assign(pkg.devDependencies, {
      '@vue/eslint-config-standard': '^3.0.0-beta.8'
    })
  } else if (config === 'prettier') {
    pkg.eslintConfig.extends.push('@vue/prettier')
    Object.assign(pkg.devDependencies, {
      '@vue/eslint-config-prettier': '^3.0.0-beta.8'
    })
  } else {
    // default
  ...
  if (api.hasPlugin('typescript')) {
    ...
    Object.assign(pkg.devDependencies, {
      '@vue/eslint-config-typescript': '^3.0.0-beta.8'
    })
  }
